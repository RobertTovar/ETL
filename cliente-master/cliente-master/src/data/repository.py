...
class Repository:
    ...
    @staticmethod
    def get_month_sales_reports(year):
        response = Provider.execute(Queries.get_month_sales_reports(year))
        return response

    @staticmethod
    def get_month_sales_count(year):
        response = Provider.execute(Queries.get_month_sales_count(year))
        return response